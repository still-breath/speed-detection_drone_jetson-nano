...
@torch.no_grad()
def run(
        source="percobaan 20m.mp4", # IP RTMP Stream
    ...
    inference_log_file = open(save_dir / 'inference_log.txt', 'w')
    inference_times = []
    ...
    while True:
        try:
            ...
            for frame_idx, data in frame_iter:
                ...
                inference_log_file.write(f"{end_time},{inference_time}\n")
